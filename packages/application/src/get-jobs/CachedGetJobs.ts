import { GetJobs, GetJobsFilters, PaginationOptions, GetJobsResult } from './GetJobs';
...
export class CachedGetJobs extends GetJobs {
  ...
  private getCacheKey(filters: GetJobsFilters, pagination: PaginationOptions): string {
