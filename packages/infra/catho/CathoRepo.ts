...
export class CathoRepo implements JobRepository {
  public readonly source = "Catho";
  ...
  async listAll(): Promise<Job[]> {
    try {
      ...
      console.error("Erro ao buscar vagas do Catho:", error);
      return [];
    }
  }
  ...
  async getById(id: string): Promise<Job | null> {
    try {
      ...
      console.error("Erro ao buscar vaga específica do Catho:", error);
      return null;
    }
  }
